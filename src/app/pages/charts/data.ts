import { ApexLinearChartData, ApexNonLinearChartData, Point, Range } from "./charts.model";
...
const radialChartData: ApexNonLinearChartData = {
    data: [70]
};

const multiRadialChartData: ApexNonLinearChartData = {
    data: [44, 55, 67, 83]
};
